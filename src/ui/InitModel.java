...
public class InitModel {
    ...
    public Battery[] createBatteries(){
        ...
        batteries[6] = new RechargeableBattery("AAA", 1.2, 600, 250, 2000, Type.LITIO);
        batteries[7] = new RechargeableBattery("AA", 2, 205, 400, 1200,  Type.LITIO);
        batteries[8] = new RechargeableBattery("D", 12, 400, 1000, 500, Type.NIQUEL_CADIO);
        batteries[9] = new RechargeableBattery("C", 4.5, 62, 521, 800,  Type.NIQUEL_CADIO);
